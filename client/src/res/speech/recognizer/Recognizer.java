...
public class Recognizer {
    ...
    * @param profanityFilter The profanity Filter
     ...
     */
    public GoogleResponse getRecognizedDataForWave(File waveFile, int maxResults) throws org.json.JSONException, IOException{
     ...
     * @throws IOException Throws exception if something goes wrong
     */
    public GoogleResponse getRecognizedDataForWave(String waveFile, int maxResults) throws org.json.JSONException, IOException {
     ...
     * @throws IOException Throws exception if something goes wrong
     */
    public GoogleResponse getRecognizedDataForFlac(File flacFile, int maxResults) throws org.json.JSONException, IOException {
     ...
     */
    public GoogleResponse getRecognizedDataForFlac(File flacFile, int maxResults, int sampleRate) throws org.json.JSONException, IOException{
     ...
     * @throws IOException if something goes wrong
     */
    public GoogleResponse getRecognizedDataForFlac(String flacFile, int maxResults, int sampleRate) throws org.json.JSONException, IOException{
     ...
     * @throws IOException Throws exception if something goes wrong
     */
    public GoogleResponse getRecognizedDataForFlac(String flacFile, int maxResults) throws org.json.JSONException, IOException {
     ...
     * @throws IOException Throws exception if something goes wrong
     */
    public GoogleResponse getRecognizedDataForWave(File waveFile) throws org.json.JSONException, IOException {
     ...
     * @throws IOException Throws exception if something goes wrong
     */
    public GoogleResponse getRecognizedDataForWave(String waveFile) throws org.json.JSONException, IOException {
        return getRecognizedDataForWave(waveFile, 1);
    }
     ...
     * @throws IOException Throws exception if something goes wrong
     */
    public GoogleResponse getRecognizedDataForFlac(File flacFile) throws org.json.JSONException, IOException {
     ...
     * @throws IOException Throws exception if something goes wrong
     */
    public GoogleResponse getRecognizedDataForFlac(String flacFile) throws org.json.JSONException, IOException {
        return getRecognizedDataForFlac(flacFile, 1);
    }
     ...
     */
    private void parseResponse(String[] rawResponse, GoogleResponse googleResponse) throws org.json.JSONException {
